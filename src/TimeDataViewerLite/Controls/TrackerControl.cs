...
public class TrackerControl : ContentControl
{
    ...
    private void OnPositionChanged(AvaloniaPropertyChangedEventArgs _)
    {
        UpdatePositionAndBorder();
    }
    ...
    public static readonly StyledProperty<OxyRect> LineExtentsProperty =
        AvaloniaProperty.Register<TrackerControl, OxyRect>(nameof(LineExtents), new OxyRect());
    ...
    public static readonly StyledProperty<double> DistanceProperty =
        AvaloniaProperty.Register<TrackerControl, double>(nameof(Distance), 7.0);
    ...
    public static readonly StyledProperty<bool> CanCenterHorizontallyProperty =
        AvaloniaProperty.Register<TrackerControl, bool>(nameof(CanCenterHorizontally), true);
    ...
    public static readonly StyledProperty<bool> CanCenterVerticallyProperty =
        AvaloniaProperty.Register<TrackerControl, bool>(nameof(CanCenterVertically), true);
    ...
    public static readonly StyledProperty<ScreenPoint> PositionProperty =
        AvaloniaProperty.Register<TrackerControl, ScreenPoint>(nameof(Position), new ScreenPoint());
    ...
    public static readonly StyledProperty<Thickness> MarginPointerProperty =
        AvaloniaProperty.Register<TrackerControl, Thickness>(nameof(MarginPointer), new Thickness());
