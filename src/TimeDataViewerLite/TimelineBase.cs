...
using TimeDataViewerLite.Controls;
...
public abstract partial class TimelineBase : TemplatedControl, IPlotView
{
    ...
    public void SetCursorType(CursorType cursorType)
    {
        Cursor = cursorType switch
        {
            ...
            CursorType.PanHorizontal => PanHorizontalCursor,
    ...
    {
        if (_canvasBack == null || _canvasFront == null || _panel == null || _canvasX == null || _drawCanvas == null)
        {
            return;
        }
