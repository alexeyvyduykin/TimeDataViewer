...
{
    public class TrackerControl2 : ContentControl
    {
        public static readonly StyledProperty<OxyRect> LineExtentsProperty = AvaloniaProperty.Register<TrackerControl2, OxyRect>(nameof(LineExtents), new OxyRect());
        public static readonly StyledProperty<double> DistanceProperty = AvaloniaProperty.Register<TrackerControl2, double>(nameof(Distance), 7.0);
        public static readonly StyledProperty<bool> CanCenterHorizontallyProperty = AvaloniaProperty.Register<TrackerControl2, bool>(nameof(CanCenterHorizontally), true);
        public static readonly StyledProperty<bool> CanCenterVerticallyProperty = AvaloniaProperty.Register<TrackerControl2, bool>(nameof(CanCenterVertically), true);
        public static readonly StyledProperty<ScreenPoint> PositionProperty = AvaloniaProperty.Register<TrackerControl2, ScreenPoint>(nameof(Position), new ScreenPoint());
        public static readonly StyledProperty<Thickness> MarginPointerProperty = AvaloniaProperty.Register<TrackerControl2, Thickness>(nameof(MarginPointer), new Thickness());

        private ContentPresenter? _content;
        private Panel? _contentContainer;

        static TrackerControl2()
        {
            ClipToBoundsProperty.OverrideDefaultValue<TrackerControl2>(false);
        ...
        {
            ((TrackerControl2)sender).OnPositionChanged(e);
        }
